...
public class FlaskGameStateOld {
    ...
    public FlaskGameStateOld createCopy(){
        // Need tp deep clone manually.
        FlaskGameStateOld copy = new FlaskGameStateOld();
    ...
    public static FlaskGameStateOld buildState(List<List<Color>> flasks){
